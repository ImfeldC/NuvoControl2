...
svn export https://svn2.xp-dev.com/svn/ImfeldC-NuvoControl/source/trunk e:\NuvoControl\source\
echo export documentation files ...
svn export https://svn2.xp-dev.com/svn/ImfeldC-NuvoControl/documentation e:\NuvoControl\documentation\
